                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp">
                        <div class="kt-portlet__body">
                            ...
                            <label class="kt-checkbox kt-checkbox--tick kt-checkbox--brand">
                             ...
                             <input type="text"  id="txtP7_2_6_O" name="txtP7_2_6_O" class="form-control"   placeholder="Especifique"> 
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp">
                        <div class="kt-portlet__body">
                            ...
                            <label class="kt-checkbox kt-checkbox--tick kt-checkbox--brand">
                                ...
                                6. Otro<span></span></label>
                            <input type="text"  id="txtP7_3_6_O" name="txtP7_3_6_O" class="form-control"   placeholder="Especifique"> 
                        </div>
                    </div>
                </div>
            </div>
