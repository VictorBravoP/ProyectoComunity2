                        ...
                        <div class="form-group row form-group-marginless kt-margin-t-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp">
                                <div class="kt-portlet__body">
                                    ...
                                    <input type="text"  id="txtP2_3_12_O" name="txtP2_3_12_O" class="form-control"   placeholder="Especifique"> 
                ...
                <div class="form-group  form-group-marginless" id="P2_8" name="P2_8">
                    <div class="col-lg-12">
                        <div class="form-group row form-group-marginless kt-margin-t-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp">
                                <div class="kt-portlet__body">
                                    <input type="text"  id="txtP2_8_1" name="txtP2_8_1" class="form-control" > 
                                    <input type="text"  id="txtP2_8_2" name="txtP2_8_2" class="form-control" > 
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
            ...
            function InicializaRep() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("input[name='txtP2_4'][value=" + data.d.data[0].P2_4 + "]").prop('checked', true);
        ...
        function saveData() {        
            ...
            Formulario.push({
                ...
                'P2_4': $('#txtP2_4').val(),
                'P2_5_1': $('#txtP2_5_1').val(),
                'P2_5_2': $('#txtP2_5_2').val(),
                'P2_5_3': $('#txtP2_5_3').val(),
                'P2_5_4': $('#txtP2_5_4').val(),
                'P2_5_5': $('#txtP2_5_5').val(),
                'P2_5_6': $('#txtP2_5_6').val(),
                'P2_5_7': $('#txtP2_5_7').val(),
                'P2_5_8': $('#txtP2_5_8').val(),
                'P2_6': $('#txtP2_6').val(),
                'P2_7_1': $('#txtP2_7_1').val(),
                'P2_7_2': $('#txtP2_7_2').val(),
                'P2_7_3': $('#txtP2_7_3').val(),
                'P2_7_4': $('#txtP2_7_4').val(),
                'P2_7_5': $('#txtP2_7_5').val(),
                'P2_7_6': $('#txtP2_7_6').val(),
                'P2_7_7': $('#txtP2_7_7').val(),
                'P2_7_8': $('#txtP2_7_8').val(),
                'P2_7_9': $('#txtP2_7_9').val(),
