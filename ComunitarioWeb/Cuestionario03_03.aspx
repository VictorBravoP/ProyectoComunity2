 ...
 <!--HERE     --->
            ...
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_1. En total, ¿a cuántos pacientes hospitalizados con COVID-19 (moderada, grave y crítica) tiene el hospital capacidad de tratar?</strong></label>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_2" name="P3_2">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_2. Del número total, ¿a cuántos pacientes hospitalizados con COVID-19 grave, que no requieran cuidados intensivos, tiene capacidad el hospital de tratar?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_3" name="P3_3">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_3. Del número total, ¿a cuántos pacientes hospitalizados con COVID-19 crítica, que requieran cuidados intensivos, tiene capacidad el hospital de tratar?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_4" name="P3_4">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_4. Refiriéndonos a esta mañana, ¿cuántos pacientes con diagnóstico presunto o confirmado de COVID-19 habían pasado la noche en el hospital?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_5" name="P3_5">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_5. Refiriéndonos a la mañana de ayer, ¿cuántos pacientes con diagnóstico presunto o confirmado de COVID-19 habían pasado la noche en el hospital?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_6" name="P3_6">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_6. Del total de camas de hospitalización, ¿cuántas están actualmente preparadas para ser utilizadas como camas de aislamiento respiratorio?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_7" name="P3_7">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_7. Si fuera necesario, ¿cuántas camas de hospitalización adicionales podrían convertirse o añadirse para su uso como camas de aislamiento respiratorio?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_8" name="P3_8">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_8. Si fuera necesario, ¿cuántas camas de hospitalización adicionales podrían convertirse o añadirse para utilizarlas como camas de UCI?</strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_9" name="P3_9">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_9. Refiriéndonos a esta mañana,  ¿cuántos pacientes en total han pasado la noche en el hospital? </strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
        ...
        <div class="form-group  form-group-marginless" id="P3_10" name="P3_10">
            <div class="col-lg-12">
                <div class="form-group row form-group-marginless kt-margin-t-0">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-preg">
                        <label class="col-form-label"><strong>P3_10. Refiriéndonos a todo el mes anterior, ¿cuántos pacientes pasaron la noche en el hospital cada día de media? </strong></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 grid-border-resp ">
                        <div class="kt-portlet__body">AQUI IRA </div>
                    </div>
