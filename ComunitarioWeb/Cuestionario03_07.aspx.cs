...
{
    public partial class Cuestionario03_07 : System.Web.UI.Page
    {
        ...
        public static object CargarDatos(String cod_establecimiento, String seccion, String usuario)
        {
            ...
            List<Model.Cuestionario03> lista = cuestionario03BL.cargarCuestionario03_07(cod_establecimiento, seccion, usuario);
            object json = new { data = lista };
            return json;
        }

        [WebMethod(EnableSession = true)]
        public static object GuardarCuestionario03_07(List<Model.Cuestionario03> pDocumento, System.String pUsuario)
        {
            Cuestionario03BL obl = new Cuestionario03BL();

            bool respuesta = obl.GuardarCuestionario03_07(pDocumento, pUsuario);
            var informacion = "";
