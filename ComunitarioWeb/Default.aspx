...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ComunitarioWeb._Default" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="@Url.Content("~/assets/css/main.css")"/>

    <script src="~/Scripts/jquery_LinkFish.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.3/jquery.validate.min.js"></script>
    <script src="~/Scripts/Login/Login.js"></script>
    <script src="~/Scripts/autocomplete.js"></script>
    <link href="~/assets/css/login/font-Raleway.css" rel="stylesheet" />

	<link href="../assets/demo/default/base/main_login.css" rel="stylesheet" type="text/css" />


    <script src="@Url.Content("~/Scripts/jquery-ui-1.8.24.min.js")" type="text/javascript"></script>
    <script src="@Url.Content("~/Scripts/jquery-migrate-1.0.0.js")" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="@Url.Content("~/assets/fonts/style.css")"/>
    <link rel="stylesheet" type="text/css" href="@Url.Content("~/assets/css/main.css")"/>
    <link rel="stylesheet" type="text/css" href="@Url.Content("~/assets/css/main-responsive.css")"/>

    <link href="@Url.Content("~/assets/plugins/jquery-ui/jquery-ui-1.10.1.custom.css")" rel="stylesheet" type="text/css" />
</head>
<body class="login linkfish">
    <div class="main-login">


        <div class="box-login2" >
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 701.86 177.96" class="logo svg replaced-svg">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #0093d5;
        ...
        <div class="box-login" style="display: block;">
            ...
            <form class="form-login" runat="server" method="POST">
                    ...
                    <div class="errorHandler alert alert-danger no-display">
                        <i class="clip-warning"></i>&nbsp El usuario/clave son incorrectos.
                    </div>
                    <div class="new-account" style="border-top: 1px solid;">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //var sad = crypto.getRandomValues(array)[0]; 
            //var saa = Math.random();
            Login.init();
            ...
            var Login = function () {
                var a = function () {
                    ...
                    c = function () {
                        ...
                        a.validate({
                            ...
                            messages: {
                                ...
                                passname: {
                                    required: "[Clave de usuario] es obligatorio"
                                }
                            },
                    ...
                    g = function (_u, _p, _b) {
                        if (i(_u, _p, _b)) {
                            window.location = baseUrl + "Home/Index?usuario=" + _x;
                        }
                    },
                    i = function (_u, _p, _b) {
                        var exito = false;
                        ...
                        var url = baseUrl + 'Login/LoginX/Usuario_Login';
